...
public class MockObjects {
    ...
    public static User getJean() {
        ...
        batch.setBatchNumber(15);
        adonis.setBatch(batch);
        adonis.setFirstName("Jean");
        adonis.setLastName("Lucas");
        adonis.setEmail("jean@lucas.com");
        adonis.setPhoneNumber("123-456-7890");
        adonis.setDriver(true);
        adonis.setActive(true);
        adonis.setAcceptingRides(true);
        ...
        address.setState("VA");
        address.setStreet("456 Real Street");
        address.setZip("456456");
        address.setId(6);
        adonis.setHAddress(address);
        adonis.setWAddress(address);
        return adonis;
