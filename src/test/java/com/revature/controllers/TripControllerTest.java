...
public class TripControllerTest {
    ...
    public void testDeleteTripById() throws Exception {
        ...
        mockMvc.perform(delete("/trips/{id}", 1))
    ...
    public void testGetTripsByRiderId() throws Exception {
        ...
        UserDTO rider = new UserDTO(MockObjects.getJean());
        riders.add(rider);
        ...
        mockMvc.perform(get(String.format("%s%s%s", "/trips/rider", "?riderId=", rider.getUserId())))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", hasSize(2)));
    }
    ...
    public void testUpdateTripRiders() throws Exception {
        ...
        User rider = MockObjects.getJean();
